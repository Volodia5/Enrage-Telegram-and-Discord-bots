...
namespace EnrageTgBotILovePchel.Service
{
    public class SearchTeammateMenuService
    {
        ...
        public BotMessage ProcessClickOnInlineButtonFilter(string textData, TransmittedData transmittedData)
        {
            ...
            {
                List<UsersDatum> usersData = _usersDatasRepository.GetAllUserExcept(transmittedData.ChatId, 1, 0, 12000);
            ...
            {
                List<UsersDatum> usersData = _usersDatasRepository.GetAllUserExcept(transmittedData.ChatId, 2, 0, 12000);
            ...
            {
                List<UsersDatum> usersData = _usersDatasRepository.GetAllUserExcept(transmittedData.ChatId, 3, 0, 12000);
            ...
            {
                List<UsersDatum> usersData = _usersDatasRepository.GetAllUserExcept(transmittedData.ChatId, 4, 0, 12000);
            ...
            {
                List<UsersDatum> usersData = _usersDatasRepository.GetAllUserExcept(transmittedData.ChatId, 5, 0, 12000);
